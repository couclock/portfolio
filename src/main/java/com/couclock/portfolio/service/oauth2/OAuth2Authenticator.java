...
public class OAuth2Authenticator {
	...
	public static final class OAuth2Provider extends Provider {
		...
		public OAuth2Provider() {
			...
			put("SaslClientFactory.XOAUTH2", "com.couclock.portfolio.service.oauth2.OAuth2SaslClientFactory");
		}
	}
	...
	public static SMTPTransport connectToSmtp(String host, int port, String userEmail, String oauthToken, boolean debug)
		...
		Session session = getSession(oauthToken, debug);
	...
	public static Session getSession(String oauthToken, boolean debug) {

		if (OAuth2Authenticator.session == null) {
			...
			OAuth2Authenticator.session = Session.getInstance(props);
			OAuth2Authenticator.session.setDebug(debug);
		}

		return OAuth2Authenticator.session;
	}
	...
	public static void main(String args[]) throws Exception {
		...
		Message message = new MimeMessage(getSession(oauthToken, true));
		message.setSubject("Submit from somedomain.com website");
		message.setText("Name=" + "\n\nEmail=" + "\n\nPhone=" + "\n\nMessage=");

		Address toAddress = new InternetAddress("dany.lecoq@gmail.com");
